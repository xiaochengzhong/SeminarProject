...
/**
 * Servlet implementation class adminreqnextpic
 */
public class adminreqnextpic extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminreqnextpic() {
        super();
	...
	protected String getNextPic(String userID , String taskSetID , String picsetID , String picID , String webPath) {
		...
		picObj nextPic =  mOperator.admingetNextPicFDB(userID , taskSetID , picsetID , picID);
