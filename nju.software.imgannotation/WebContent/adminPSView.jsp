	...
	<div id="wrapper">
		...
		<center><h2>图像集信息</h2></center>
				...
				<table style="width: 100%; margin-bottom: 0px;">
					...
					<tr>
						...
						<td><textarea
								...
								id="ps_desp" disabled="disabled"><%=(mpicset.getdesp()) %></textarea></td>
					</tr>
					<tr>
			...
			<div id="FVContent" class="fileMenuList">
				<jsp:include flush="true" page="adminsimplefs.jsp"></jsp:include>
			</div>
			<div class="fileMenuReview">
				<div id="ps_review" style="float: left; width: 100%">
					...
					<div id="ps_content" class="togethercontent"
						...
						<a onclick="getReadFilelist('<%=(folderls.get(i)) %>')" class="filefolder">/<%=(folderls.get(i)) %></a>
					</div>
					<%} %>
				</div>
