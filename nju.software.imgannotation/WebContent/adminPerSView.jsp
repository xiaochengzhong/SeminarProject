				...
				<table style="width: 100%; margin-bottom: 0px;margin-left: 15px;">
					<tr>
						...
						<td style="width: 90%"><input id="ps_tittle" type="text"
							style="width: 500px" value="<%=(mPESet.getTittle()) %>" disabled="disabled"></td>
						</td>
					</tr>
					<tr>
						...
						<td><textarea
								...
								id="ps_desp" disabled="disabled"><%=(mPESet.getDesp()) %></textarea></td>
					</tr>
					<tr>
					...
					<table>
						...
						<div class="personDiv">
							<input type="checkbox" id="pl_<%=(mUseList.get(i).getID())%>"
								style="height: 30px; width: 20px;" checked disabled="disabled">
							<%
